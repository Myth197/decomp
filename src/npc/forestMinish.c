...
const Dialog gUnk_08109DC8[][4] = {
    ...
    {
        { FUSION_WESTERN_WOODS_BEANSTALK,
          DIALOG_KINSTONE,
          DIALOG_CHECK_FLAG,
          1,
    ...
    },
    {
        ...
        { FUSION_TRILBY_HIGHLANDS_PUDDLE,
          DIALOG_KINSTONE,
          DIALOG_CHECK_FLAG,
          1,
        ...
        { FUSION_TRILBY_HIGHLANDS_PUDDLE,
          ...
          { TEXT_INDEX(TEXT_MINISH, 0xe), TEXT_INDEX(TEXT_MINISH, 0xa) } },
#else
        { FUSION_TRILBY_HIGHLANDS_ISLAND,
          DIALOG_KINSTONE,
          DIALOG_CHECK_FLAG,
          1,
          { TEXT_INDEX(TEXT_MINISH, 0xe), TEXT_INDEX(TEXT_MINISH, 0xa) } },
    ...
    {
        { FUSION_EASTERN_HILLS_BEANSTALK,
          DIALOG_KINSTONE,
          DIALOG_CHECK_FLAG,
          1,
...
void sub_080601D4(Entity* this) {
    ...
    if (CheckGlobalFlag(LV3_CLEAR) == 0) {
        uVar2 = 2;
    } else if (CheckKinstoneFused(FUSION_WIND_RUINS_BEANSTALK)) {
        uVar2 = 1;
    } else {
        uVar2 = 0;
    }
