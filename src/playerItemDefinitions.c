...
const SpriteDataC gPlayerItemDefinitions[] = {
    ...
    { 0, 3, 5130, 118, SPRITE_ITEM_BOOMERANG, 0 },  // PlayerItemBoomerang
    { 1, 3, 5391, 171, SPRITE_ITEM_BOW, 203 },      // PlayerItemBow
    MULTI_FORM(2, 13),                              // PlayerItemShield
    { 0, 0, 1792, 1, SPRITE_ITEM_LANTERN, 0 },      // PlayerItemLantern
    MULTI_FORM(0, 1),                               // PlayerItemNulled
    { 1, 0, 16384, 1, SPRITE_ITEM_GUST_JAR, 0 },    // PlayerItemGustJar
    { 4, 0, 16384, 1, SPRITE_ITEM_PACCI_CANE, 0 },  // PlayerItemPacciCane
    { 0, 0, 16384, 1, SPRITE_0, 0 },                // DeleteEntity
    { 0, 0, 16384, 1, SPRITE_0, 0 },                // DeleteEntity
    MULTI_FORM(1, 1),                               // PlayerItemDashSword
    MULTI_FORM(0, 1),                               // PlayerItemCellOverwriteSet
    { 0, 0, 7936, 1, SPRITE_ITEM_SWORD_SPIN, 0 },   // PlayerItemSwordSpin
