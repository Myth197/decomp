...
typedef enum {
    ...
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_NORTHWEST = 0,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_NORTH,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_NORTHEAST,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_WEST,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_MIDDLE,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_EAST,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_SOUTHWEST,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_SOUTH,
    ROOM_CASTLE_UNDERGROUND_TEST_DUNGEON_SOUTHEAST,
