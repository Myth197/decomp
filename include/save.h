...
typedef struct {
    ...
    /*0x040*/ u32 windcrests;                /**< upper 8 bit Windcrest flags @see WindcrestID
                                              * lower bits used for Pause Screen Map Square Revealed flags */
    ...
    /*0x060*/ u32 areaVisitFlags[8];         /**< Area visit flags. Upper 8 bit Dungeon flags. Lower 8 bit Overworld flags */
